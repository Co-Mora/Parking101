...
import CarParkTenant from "./components/PageCarPark/CarParkTenant/CarParkTenant";
...
const router = new VueRouter({
    ...
    routes: [
        ...
        },
        {
            ...
            props: route => ({
                carparkID: route.query.carparkID,
        ...
        {
            path: "/v1/carpark-tenant",
            name: "CarParkTenant",
            component: CarParkTenant
        },
        {
