<template>
  <div>
    <div id="wrapper">
      <nav-side :classPersonalParkers="classPersonalParkers" />
      <div id="page-wrapper" class="gray-bg">
        <NavBar />
        <div class="ibox-title">
          <p>Home / Parking License / Customer List / Personal Parkers</p>
        </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-12 m-b-xs" style="margin-bottom:10px;">
                      <chosen-select
                        ...
                        v-if="customerID && customers.length > 0"
                        ref="input"
